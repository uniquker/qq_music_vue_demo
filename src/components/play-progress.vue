...
<div>
    <div class="controller-wrap">
        <div class="row" v-if="showController">
            ...
            <i class="icon icon-fav" @click="msgIsShow"></i>
        </div>
        <div class="songList" v-else>
            ...
            <ul>
                <template v-if="!list.data" v-for="(item, index) in list">
                    <li :class='{"active": index == _index}' @click='changeSong' :songIndex="index">{{item.name || item.songname || (item.data?item.data.songname:item.musicData.songname)}}
                        <b v-if="index == _index"><i></i><i></i><i></i><i></i></b>
                    </li>
                </template>
                <template v-else-if="!list.musicData" v-for="(item, index) in list">
                    <li :class='{"active": index == _index}' @click='changeSong' :songIndex="index">{{item.name || item.songname || item.musicData.songname}}
                        <b v-if="index == _index"><i></i><i></i><i></i><i></i></b>
                    </li>
                </template>
